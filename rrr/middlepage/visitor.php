			...
			<div class="container">
				<div class="row">
					...
					<form action="index.php?page=visitor_action" method="post" onclick="return validatevisitor();" enctype="multipart/form-data" data-toggle="validator" novalidate="true">
					    ...
					    <div class="form-group col-md-6">
							<input type="number" min='5' step='0.1' class="form-control" id="txtqty" placeholder="Enter Food Quantity in Kgs" name="foodqty" required="">
							<div  id="req_qty" class="text-danger" style="display:none;">*Enter Valid Food Quantity</div>
						</div>
						<div class="form-group col-md-6">
							<div id="success"></div>
