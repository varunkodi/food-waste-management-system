							...
							<form action="index.php?page=request_action"  method="post" onsubmit="return validaterequest();" enctype="multipart/form-data" class="form-contact"  data-toggle="validator" novalidate="true">
								...
								<div class="row">
								    FOOD TYPE:<div class="col-sm-6 col-md-5" style="margin-left: 31px;">
										<div class="form-group">
											<input type="text" class="form-control" id="txtfoodtype" name="foodtype" placeholder="Enter Food Type">
							    ...
							    FOOD QUANTITY:<div class="col-sm-6 col-md-5">
										<div class="form-group">
											  <input type="number" min="5" step="0.1" class="form-control" id="txtfoodqty" name="foodqty" placeholder="Enter Food Quantity">
											  <div  id="req_qty" class="text-danger" style="display: none;">*Field is valid and Required</div>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<!-- <div class="row">
									DATE:              <div class="col-sm-6 col-md-5" style="margin-left: 28px;">
										<div class="form-group">
								...
								<div class="form-group">
									<div id="success"></div>
									<input type="submit" name="request" class="btn btn-primary" value="Donate">
								</div>
							</form>
						 </div>
					</div>
