			    ...
			    <nav class="navbar navbar-expand-lg">
			        ...
			        <div class="collapse navbar-collapse" id="navbarNavDropdown">
						...
						?>
							...
							<li class="nav-item">
			                    <a class="nav-link" href="index.php?page=ngofeedback&hotel_id=<?php echo $_SESSION['ngo_id'];?>">FEEDBACK</a>
			                </li>
			            <?php } 
						...
						?>  
							...
							<li class="nav-item">
			                    <a class="nav-link" href="index.php?page=hotelfeedback&hotel_id=<?php echo $_SESSION['hotel_id'];?>">FEEDBACK</a>
			                </li>
							<li class="nav-item">
			                    <a class="nav-link" href="index.php?page=dashboard">DONATION HISTORY</a>
			                </li>
